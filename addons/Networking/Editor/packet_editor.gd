...
func _on_save_pressed() -> void:
	...
	var file = FileAccess.open("res://addons/Networking/Editor/packet_types.gd", FileAccess.WRITE)
	if file:
		var i = 0
		file.store_string("#Note: Do not edit this file, it is autogenerated.\n")
		file.store_string("extends Node\n\n")
		for def in _doc.packets:
